...
# pmyexp <- paste0("DT0002", experimiento)
...
# pmyexp <- paste0("CA0001", experimiento)
# pinputexps <- paste0("DT0002", experimiento)
# pserver <- "local"
...
# pmyexp <- paste0("DR0001", experimiento)
# pinputexps <- paste0("CA0001", experimiento)
# pserver <- "local"
...
# pmyexp <- paste0("FE0001", experimiento)
# pinputexps <- paste0("DR0001", experimiento)
# pserver <- "local"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( paste0("DT0001", experimiento), "competencia_2024.csv.gz")
  CA_catastrophe_default( paste0("CA0001", experimiento), paste0("DT0001", experimiento) )

  DR_drifting_guantesblancos( paste0("DR0001", experimiento), paste0("CA0001", experimiento) )
  FE_historia_guantesblancos( paste0("FE0001", experimiento), paste0("DR0001", experimiento) )

  TS_strategy_guantesblancos_202109( paste0("TS0001", experimiento), paste0("FE0001", experimiento) )

  HT_tuning_guantesblancos( paste0("HT0001", experimiento), paste0("TS0001", experimiento) )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( paste0("ZZ0001", experimiento), c(paste0("HT0001", experimiento) ,paste0("TS0001", experimiento)) )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  # Ya tengo corrido FE000101 y parto de alli
  TS_strategy_guantesblancos_202107( paste0("TS0002", experimiento), paste0("FE0001", experimiento) )

  HT_tuning_guantesblancos( paste0("HT0002", experimiento), paste0("TS0002", experimiento) )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( paste0("ZZ0002", experimiento), c(paste0("HT0002", experimiento), paste0("TS0002", experimiento)) )
...
corrida_guantesblancos_202109( paste0("gs01", experimiento) )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( paste0("gs02", experimiento) )
